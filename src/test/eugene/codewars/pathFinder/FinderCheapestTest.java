...
public class FinderCheapestTest {
    @Test
    public void sampleTest1() {
        ...
        assertEquals(expected, FinderCheapest.cheapestPath(tollMap, start, finish));
    }
    ...
    public void sampleTest4() {
        ...
        List<String> expected = Arrays.asList("down", "down", "down", "right", "right");
